    ...
    return (
        <section className="h-auto lg:h-[890px] relative text-white pt-4 pb-0 overflow-visible bg-[url('/hero-mobile.png')] bg-cover bg-no-repeat bg-top md:bg-[url('/hero.png')]">
            ...
            <div className="relative z-10">
                {/* Header embutido */}
                <div className="flex items-center justify-between max-w-7/1 lg:w-[1216px] mx-auto mb-12 px-5 lg:px-10 py-[13px]">
                    {/* Logo + Navbar */}
                ...
                {/* Hero principal */}
                <div className="text-center px-10 lg:px-5 mb-10 mt-10 md:mt-20">
                    <span
