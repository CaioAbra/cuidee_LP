        ...
        <section className="h-auto lg:h-[890px] relative text-white pt-4 pb-0 overflow-visible bg-[url('/hero-mobile.png')] bg-cover bg-no-repeat bg-top md:bg-[url('/hero.png')]">
            ...
            <div className="relative z-10" >
                ...
                <div className={`text-center px-[24px] md:px-8 mb-10 ${
                    ...
                    <h1 data-animate="fade-up" className="text-white text-center font-raleway font-bold not-italic text-[40px] leading-[48px] tracking-[-1px] lg:text-[70px] lg:leading-[84px] lg:max-w-[850px] mx-auto">
                ...
                <img data-animate="fade-up" src="/medicos/medicos.png" alt="Médicos Cuidee" className="hidden md:block mx-auto mt-[100px] md:w-[1449px] md:h-[292px]" />
                <img data-animate="fade-up" src="/medicos/medicos-mobile.png" alt="Médicos Cuidee" className="block md:hidden mx-auto mt-[50px] w-full pb-[50px]" />
            </div>
        </section>
    );
}
