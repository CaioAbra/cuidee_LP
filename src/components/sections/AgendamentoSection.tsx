...
export default function AppointmentSection() {
    ...
    return (
        <section data-animate="fade-up" className="max-w-[1216px] mx-auto px-[24px] md:px-8 pt-[56px] md:pt-[100px] flex flex-col md:flex-row justify-between gap-10 lg:gap-[120px] ">
